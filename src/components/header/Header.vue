<template>
  ...
  <div style="background-color: #f5f5f5;height: 32px;">
      <div @mouseover="selectStyle()" @mouseout="outStyle()"  class="col-xs-offset-9 col-xs-1 geu-header-language text-center">
        <span v-text="$t('m.changeLan')"></span> <span class="glyphicon glyphicon-menu-down"></span>
      </div>
    <!--@mouseout="outStyle()"-->
  </div>
    <div style="position: relative">
      <div @mouseout="outStyle()" @mouseover="selectStyle()"  v-bind:class="{'geu-header-language-li-k': use}" class="col-xs-offset-9 col-xs-1 geu-header-language-ul" style="cursor: pointer;">
