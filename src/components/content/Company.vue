...
<!--          </div>-->
        ...
        <div class="col-xs-12 text-center margin-top-100">
          ...
          <div class="col-xs-3">
            <img class="" src="../../assets/img/company_t1.png"/>
          </div>
          <div class="col-xs-3">
            <img class="" src="../../assets/img/company_t2.png"/>
          </div>
          <div class="col-xs-3">
            <img class="" src="../../assets/img/company_t3.png"/>
          </div>
          <div class="col-xs-1"></div>
        </div>
        ...
        <div class="col-xs-12 text-center" style="margin-top: 200px;">
          <img class="" src="../../assets/img/companylogo.jpg"/>
        </div>
...
<!--          <img class="" src="../../assets/img/company_building.png"/>-->
<!--        </div>-->
    </div>
</template>
