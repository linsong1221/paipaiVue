<template>
  <div>
    ...
    <div class="geu-home-leone-div">
      <div class="geu-home-leone-service">
        <div>
          <img src="../../assets/img/con1.png"/>
        </div>
        <div class="geu-home-leone-service-div">
      ...
      <div class="col-xs-12 margin-top-70">
        ...
        <div class="col-xs-4 text-center">
          <span class="geu-home-leone-service-btitle">服务项目 / </span>
        ...
        <div class="col-xs-12 margin-top-10">
          ...
          <div class="col-xs-8 geu-home-leone-service-content"> 我司是一家专注用户体验便利，为客户提供完善的商业研究、产品提供、产品</div>
          <div class="col-xs-2"></div>
        </div>
        <div class="col-xs-12 margin-top-10">
          <div class="col-xs-2"></div>
    ...
    <div class="geu-home-thinking-back">
      ...
      <div class="geu-home-thinking-div">
        ...
        <div class="col-xs-12 text-center margin-top-65">
          <div class="col-xs-offset-4 col-xs-4 geu-home-thinking-ch-title">我们的思考方式</div>
        </div>
        ...
        <div  class="col-xs-12 text-center margin-top-30">
          <span class="geu-home-thinking-content">我们坚持站在客户的角度思考问题，用领先的互动策略思考模式打破常规。</span>
        </div>
